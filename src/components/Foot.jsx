                ...
                <div className="w-full flex flex-col md:flex-row items-start justify-between gap-8">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <ul className="flex flex-col gap-2 text-gray-400 text-sm">
                            <li>
                                <a href="#what-is-edinai" className="hover:text-white transition-colors">Ed-INAI Overview</a>
                            </li>
                            <li>
                                <a href="#ai-teachers" className="hover:text-white transition-colors">What is Ed-INAI?</a>
                            </li>
                            <li>
                                <a href="#learning-flow" className="hover:text-white transition-colors">Our AI Teachers</a>
                            </li>
                            <li>
                                <a href="#dashboard-preview" className="hover:text-white transition-colors">Implementation Guide</a>
                            </li>
                            <li>
                                <a href="#watch-demo" className="hover:text-white transition-colors">Watch Live Demo</a>
                            </li>
                        </ul>
                    </div>
                </div>
