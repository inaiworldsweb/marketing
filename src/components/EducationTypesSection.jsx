...
//             >
//               <h3 className="text-base font-semibold text-blue-400">{card.title}</h3>
...
//                 ))}
//               </ul>
//               <button className="mt-6 self-start rounded-full bg-blue-500 px-5 py-2 text-[11px] font-semibold text-white shadow-[0_0_25px_rgba(59,130,246,0.45)] transition hover:bg-blue-400">
//                 Book a Demo
//               </button>
//             </div>
//           ))}
