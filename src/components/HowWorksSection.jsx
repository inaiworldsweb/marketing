  ...
  >
    <g clipPath="url(#clip0_3091_370)">
      ...
      <g mask="url(#mask0_3091_370)">
        ...
        <g opacity="0.48" filter="url(#filter0_f_3091_370)">
          <path
            d="M32 72C43.0457 72 52 68.4183 52 64C52 59.5817 43.0457 56 32 56C20.9543 56 12 59.5817 12 64C12 68.4183 20.9543 72 32 72Z"
            fill="#FF4752"
          />
        </g>
        ...
        <path
          opacity="0.24"
          d="M1 16H63M1 48H63M16 63V1M48 63V1M5.66667 5.66667L59 59M5.66667 58.3333L58.3333 5.66666M55 32.6667C55 45.3692 44.7025 55.6667 32 55.6667C19.2975 55.6667 9 45.3692 9 32.6667C9 19.9641 19.2975 9.66667 32 9.66667C44.7025 9.66667 55 19.9641 55 32.6667Z"
          stroke="#FF4752"
          strokeWidth="0.5"
          strokeLinecap="round"
      ...
      <path
        d="M30 35V29H32C32.5304 29 33.0391 29.2107 33.4142 29.5858C33.7893 29.9609 34 30.4696 34 31C34 31.5304 33.7893 32.0391 33.4142 32.4142C33.0391 32.7893 32.5304 33 32 33M32 33H30M32 33L34 35M23 32C23 33.1819 23.2328 34.3522 23.6851 35.4442C24.1374 36.5361 24.8003 37.5282 25.636 38.364C26.4718 39.1997 27.4639 39.8626 28.5558 40.3149C29.6478 40.7672 30.8181 41 32 41C33.1819 41 34.3522 40.7672 35.4442 40.3149C36.5361 39.8626 37.5282 39.1997 38.364 38.364C39.1997 37.5282 39.8626 36.5361 40.3149 35.4442C40.7672 34.3522 41 33.1819 41 32C41 30.8181 40.7672 29.6478 40.3149 28.5558C39.8626 27.4639 39.1997 26.4718 38.364 25.636C37.5282 24.8003 36.5361 24.1374 35.4442 23.6851C34.3522 23.2328 33.1819 23 32 23C30.8181 23 29.6478 23.2328 28.5558 23.6851C27.4639 24.1374 26.4718 24.8003 25.636 25.636C24.8003 26.4718 24.1374 27.4639 23.6851 28.5558C23.2328 29.6478 23 30.8181 23 32Z"
        stroke="#FF4752"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <defs>
      ...
      >
        ...
        />
        <feGaussianBlur
          stdDeviation="6.66667"
          result="effect1_foregroundBlur_3091_370"
        />
      </filter>
      <filter
        id="filter1_f_3091_370"
        x="0"
        y="0"
        width="64"
        height="64"
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation="6.66667"
          result="effect1_foregroundBlur_3091_386"
        />
      </filter>
      <filter
        id="filter1_f_3091_386"
        x="0"
        y="0"
        width="64"
        height="64"
...
const ScheduleIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_3091_370_v)">
      ...
      <path
        d="M32 26V38M32 26L35 29M32 26L29 29M24 24H40C41.1046 24 42 24.8954 42 26V38C42 39.1046 41.1046 40 40 40H24C22.8954 40 22 39.1046 22 38V26C22 24.8954 22.8954 24 24 24Z"
        stroke="#8B5CF6"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation="6.66667"
          result="effect1_foregroundBlur_3091_370_v"
        />
      </filter>
      <filter
        id="filter1_f_3091_370_v"
        x="0"
        y="0"
        width="64"
        height="64"
...
const AiIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_3091_422)">
      ...
      />
      <path
        d="M24 39.5V24.5C24 23.837 24.2634 23.2011 24.7322 22.7322C25.2011 22.2634 25.837 22 26.5 22H39C39.2652 22 39.5196 22.1054 39.7071 22.2929C39.8946 22.4804 40 22.7348 40 23V41C40 41.2652 39.8946 41.5196 39.7071 41.7071C39.5196 41.8946 39.2652 42 39 42H26.5C25.837 42 25.2011 41.7366 24.7322 41.2678C24.2634 40.7989 24 40.163 24 39.5ZM24 39.5C24 38.837 24.2634 38.2011 24.7322 37.7322C25.2011 37.2634 25.837 37 26.5 37H40"
        stroke="#FFC933"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation="6.66667"
          result="effect1_foregroundBlur_3091_422"
        />
      </filter>
      <filter
        id="filter1_f_3091_422"
        x="0"
        y="0"
        width="64"
        height="64"
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation="6.66667"
          result="effect1_foregroundBlur_3091_441"
        />
      </filter>
      <filter
        id="filter1_f_3091_441"
        x="0"
        y="0"
        width="64"
        height="64"
...
const steps = [
  {
    ...
    color:
      "from-rose-500/25 via-black/80 to-black/95 border-rose-400/30 shadow-[0_0_35px_rgba(244,63,94,0.25)]",
    icon: <RegisterIcon />,
  },
  {
    title: "Upload your syllabus or course content",
    color:
      "from-orange-500/25 via-black/80 to-black/95 border-orange-400/30 shadow-[0_0_35px_rgba(251,146,60,0.22)]",
    icon: <UploadIcon />,
  },
  {
    title: "Schedule AI-led lectures",
    color:
      "from-violet-500/25 via-black/80 to-black/95 border-violet-400/30 shadow-[0_0_35px_rgba(124,58,237,0.22)]",
    icon: <ScheduleIcon />,
  },
  {
    title: "AI teaches, interacts",
    color:
      "from-amber-500/25 via-black/80 to-black/95 border-amber-400/30 shadow-[0_0_35px_rgba(245,158,11,0.22)]",
    icon: <AiIcon />,
  },
  {
    title: "and tracks performance",
    color:
      "from-emerald-500/25 via-black/80 to-black/95 border-emerald-400/30 shadow-[0_0_35px_rgba(16,185,129,0.22)]",
    icon: <TrackIcon />,
  },
];
