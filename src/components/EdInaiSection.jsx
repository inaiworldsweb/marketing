...
const cards = [
  {
    ...
    description:
      "A unified learning platform offering high-quality education across all subjects and streams.",
    number: "01",
  ...
  },
  {
    ...
    description:
      "Human-like interaction that builds trust, clarity, and confidence in learning.",
    number: "02",
  ...
  },
  {
    ...
    description:
      "Personalized explanations designed to maximize understanding and retention.",
    number: "03",
...
const EdInaiSection = () => {
  return (
    <section
      id="ai-teachers"
      className="bg-[#080810] text-white relative overflow-hidden py-16 sm:py-20 px-4 sm:px-8"
    >
      ...
      <div className="relative max-w-6xl mx-auto text-center space-y-8 sm:space-y-16">
        <div>
          ...
          <p className="mt-4 text-[15px] md:text-[21px] text-white/60 max-w-3xl mx-auto leading-relaxed">
            edInai is an advanced AI-powered education platform developed to
            transform traditional classrooms into intelligent, interactive
          ...
          {cards.map(({ title, description, number, icon }) => (
            <div key={title} className="relative pt-12">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(145deg, rgba(20, 20, 28, 0.95) 0%, rgba(12, 12, 18, 0.98) 100%)",
                  clipPath:
