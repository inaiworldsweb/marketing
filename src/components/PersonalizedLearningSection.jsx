...
//   return (
//     <section className="bg-gradient-to-br from-gray-900 to-black text-white py-16 px-4 sm:px-6 lg:px-8">
...
//               <div key={index} className="flex items-start space-x-4 p-4 rounded-xl hover:bg-white/5 transition-all duration-300">
//                 <div className={`flex-shrink-0 ${feature.bgColor} ${feature.color} p-3 rounded-lg`}>
//                   {feature.icon}
//                 </div>
//                 <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            {features.map((feature, index) => (
              ...
              >
                <div className={`flex-shrink-0 ${feature.color} p-3 rounded-lg bg-gray-700/50 group-hover:bg-gray-700 group-hover:shadow-[0_0_20px_currentColor] transition-all duration-300`}>
                  <div className="group-hover:scale-110 transition-transform duration-300">
                    {feature.icon}
                  </div>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-gray-200 group-hover:text-white transition-colors duration-300">{feature.title}</h3>
                </div>
              </div>
            ))}
          </div>
