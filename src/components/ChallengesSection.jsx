...
const ChallengesSection = () => {
  return (
    <section className="bg-black text-white relative overflow-hidden py-16 px-6">
      ...
      <div className="relative max-w-6xl mx-auto">
        <h2 className="text-center text-base md:text-xl font-semibold text-white/90 leading-snug">
          Overcoming Obstacles in Student Learning and
          <br />
          Engagement
        </h2>
            ...
            <div className="relative pl-12">
              ...
              <div className="mt-6 space-y-5 max-w-xl">
                {items.map((text) => (
                  <div
                    key={text}
                    className="rounded-lg border border-white/10 bg-gradient-to-r from-white/6 via-white/3 to-transparent px-6 py-4 text-[13px] md:text-sm font-medium tracking-tight text-white/90 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] min-h-[56px]"
                  >
